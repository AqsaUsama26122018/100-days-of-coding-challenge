...
//you actually have an empty list at the end of your program.
                     ...
                     //ANSWER:
let shrinkGuestList = ["Muhammad Usama", "Hussain Ahmed", "Fatima-tuz-Zahra"];
...
console.log(`"Aslam.o.alaikum ${shrinkinvitation}, I'd love to catch up over dinner!
...
shrinkGuestList.forEach(guestinvitation => console.log(`Aslam.o.alaikum ${guestinvitation} you are still invited for dinner`))

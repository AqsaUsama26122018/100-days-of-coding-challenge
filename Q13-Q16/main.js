...
//    ANSWER:
var moreGuestList = ["Muhammad Usama", "Hussain Ahmed", "Fatima-tuz-Zahra"];
console.log("".concat(moreGuestList[1], " is not comping"));
...
moreGuestList.forEach(function (moreinvitation) {
    return console.log("Aslam.o.alaikum ".concat(moreinvitation, ", I'd love to catch up over dinner!\nHow about joining me for a delecious meal this \"Saturday\" at\"8pm' at \"Do Dariya\".\nlet me know if you are free!"));
});
